    ...
    <section className="md:px-5 px-6 lg:px-8 py-12">
      ...
      <div className="w-full  mx-auto">
        <div className="grid grid-cols-1 break-words sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 mb-6">
          ...
          <div className="border-2 border-gray-300 rounded-lg grid md:hidden p-5">
            ...
            <span className="flex items-center justify-center">
              {testing.map((item) => (
                <Tooltip.Provider>
                  <Tooltip.Root>
                    <Tooltip.Trigger asChild>
                      <span className="place-content-center place-self-center pt-10 px-3 pb-3 ">
                        <img
                          src={item.logo}
                          alt={item.name}
          ...
          <div className="md:col-span-4 hidden lg:col-span-1 border-2 border-gray-300 rounded-lg md:grid grid-cols-4 md:grid-cols-2 p-5">
            <span className="bg-gradient-to-br py-6 from-sky-200 to-sky-300 gap-2 rounded-lg md:col-span-1 col-span-4 w-full h-full flex flex-col items-center justify-center">
              <div class="rounded-full flex justify-center text-gray-700 items-center w-10 h-10">
                <i className="fas fa-vial text-4xl"></i>
              </div>
          ...
          <div className="md:col-span-4 lg:col-span-2 border-2 border-gray-300 rounded-lg lg:grid-cols-3 grid p-5">
            ...
            <div className="col-span-2 grid grid-cols-2 pt-5 md:pt-0">
              {backend.map((item) => (
                <Tooltip.Provider>
                  <Tooltip.Root>
                    <Tooltip.Trigger asChild>
          ...
          <div className="md:col-span-4 border-2 gap-6 border-gray-300 relative rounded-lg grid lg:col-span-1 grid-cols-2 p-5">
            {database.map((item) => (
              <Tooltip.Provider>
                <Tooltip.Root>
                  <Tooltip.Trigger asChild>
            ...
            <span className="bg-gradient-to-br from-sky-200 to-sky-300 gap-2 col-span-2 rounded-lg w-full h-full flex flex-col items-center justify-center py-6">
          ...
          <div className="md:col-span-4 lg:col-span-2 border-2 border-gray-300 rounded-lg grid-cols-1 lg:grid-cols-3 grid p-5">
            ...
            <div className="grid-cols-3 col-span-2 pt-5 md:pt-0 grid">
