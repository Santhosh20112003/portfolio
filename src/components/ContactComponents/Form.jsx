...
function Form() {
  return (
    <section class="pb-10 md:pb-24 pt-16">
          ...
          <div class="flex items-center lg:mb-0 mb-10">
            <div class="">
              ...
              >
                ...
                />
                <button type="submit" class="w-full h-12 text-center text-white text-base font-semibold leading-6 rounded-full bg-[#213556] shadow transition-all duration-700 hover:bg-[#3a5d98]">
                  Submit
                </button>
              </form>
            </div>
