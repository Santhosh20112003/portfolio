...
function CTA() {
  return (
    <section class="text-gray-600 bg-white pb-12 md:pb-0 md:pt-6 body-font">
      <div class="pe-5 flex md:flex-row flex-col items-center justify-center">
        ...
        <div class="lg:flex-grow md:w-1/2 md:pl-16 flex-col gap-5 md:items-start md:text-left items-center text-center">
          ...
          <div class="relative flex-grow w-full md:max-w-[150px]">
            ...
            <button type="submit" class="text-white bg-[#203354] border-0 py-2 px-6 focus:outline-none hover:bg-[#2a4169] rounded-lg text-lg">
              Ready to chat ?
            </button>
          </form>
        </div>
